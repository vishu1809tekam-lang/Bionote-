...
const NOTES = [
  ...
  { tag:'Unit 02', title:'Genetics', desc:'Full B.Sc. Biotechnology-level Genetics notes, built topic by topic. Currently live: Topics 1–10 — Introduction through Cell Cycle.',
    ...
    topics:[
      ...
      `<div style="margin-bottom:4px;"><span style="font-family:var(--mono); font-size:11px; color:var(--teal); text-transform:uppercase; letter-spacing:0.08em;">Topic 9 of 31</span></div>
       <h4 style="color:var(--teal-deep); font-size:16px; margin:0 0 10px;">Types of Chromosomes</h4>
       <p style="margin:0 0 10px;">Not all chromosomes look alike, and not all of them do the same job. Some are shaped differently depending on where their centromere sits, some carry the genes that make you biologically male or female, and a few unusual types show up only in specific tissues or specific organisms, doing jobs far removed from ordinary heredity. This topic sorts chromosomes into their major categories, using both shape and function as the basis for classification.</p>
       <div style="margin:10px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Definition</span>
         <p style="margin:6px 0 0; font-size:14px;">Chromosomes can be classified by the position of their centromere (metacentric, submetacentric, acrocentric, telocentric) or by their function (autosomes, which control general body traits, versus sex chromosomes, which determine biological sex).</p>
       </div>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Classification by Centromere Position</h4>
       <p style="margin:0 0 10px;">The centromere is the constricted point where the two sister chromatids are held together, and where spindle fibers attach during division. Its position relative to the two ends of the chromosome creates four basic shapes.</p>
       <div style="margin:10px 0; padding:16px; border:1px solid var(--line); border-radius:10px; background:#fff; overflow-x:auto;">
         <div style="display:flex; gap:14px; min-width:480px; align-items:flex-end;">
           <div style="flex:1; text-align:center;">
             <div style="display:flex; flex-direction:column; align-items:center;">
               <div style="width:14px; height:34px; background:var(--teal-soft); border-radius:4px 4px 0 0;"></div>
               <div style="width:20px; height:6px; background:var(--teal-deep); border-radius:50%; margin:-2px 0;"></div>
               <div style="width:14px; height:34px; background:var(--teal-soft); border-radius:0 0 4px 4px;"></div>
             </div>
             <div style="font-size:11.5px; font-weight:600; margin-top:6px; color:var(--teal-deep);">Metacentric</div>
             <div style="font-size:10.5px; color:var(--ink-soft);">Centromere in the middle — equal arms</div>
           </div>
           <div style="flex:1; text-align:center;">
             <div style="display:flex; flex-direction:column; align-items:center;">
               <div style="width:14px; height:44px; background:var(--teal-soft); border-radius:4px 4px 0 0;"></div>
               <div style="width:20px; height:6px; background:var(--teal-deep); border-radius:50%; margin:-2px 0;"></div>
               <div style="width:14px; height:24px; background:var(--teal-soft); border-radius:0 0 4px 4px;"></div>
             </div>
             <div style="font-size:11.5px; font-weight:600; margin-top:6px; color:var(--teal-deep);">Submetacentric</div>
             <div style="font-size:10.5px; color:var(--ink-soft);">Slightly off-center — unequal arms</div>
           </div>
           <div style="flex:1; text-align:center;">
             <div style="display:flex; flex-direction:column; align-items:center;">
               <div style="width:14px; height:54px; background:var(--teal-soft); border-radius:4px 4px 0 0;"></div>
               <div style="width:20px; height:6px; background:var(--teal-deep); border-radius:50%; margin:-2px 0;"></div>
               <div style="width:14px; height:10px; background:var(--teal-soft); border-radius:0 0 4px 4px;"></div>
             </div>
             <div style="font-size:11.5px; font-weight:600; margin-top:6px; color:var(--teal-deep);">Acrocentric</div>
             <div style="font-size:10.5px; color:var(--ink-soft);">Near one end — one very short arm</div>
           </div>
           <div style="flex:1; text-align:center;">
             <div style="display:flex; flex-direction:column; align-items:center;">
               <div style="width:14px; height:60px; background:var(--teal-soft); border-radius:4px 4px 0 0;"></div>
               <div style="width:20px; height:6px; background:var(--teal-deep); border-radius:50%; margin:-2px 0;"></div>
             </div>
             <div style="font-size:11.5px; font-weight:600; margin-top:6px; color:var(--teal-deep);">Telocentric</div>
             <div style="font-size:10.5px; color:var(--ink-soft);">At the very tip — essentially one arm</div>
           </div>
         </div>
       </div>
       <p style="margin:0;">Humans don't actually have any true telocentric chromosomes — all 46 human chromosomes are metacentric, submetacentric, or acrocentric. Telocentric chromosomes do appear in some other species, such as certain rodents. This shape classification isn't just cosmetic — it's exactly what lets a trained cytogeneticist visually distinguish one chromosome from another under a microscope, which is the whole basis of karyotyping.</p>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Classification by Function — Autosomes vs Sex Chromosomes</h4>
       <p style="margin:0 0 10px;">A human cell contains 46 chromosomes in total, organized as 23 pairs. Of these, 22 pairs are <strong>autosomes</strong> (numbered 1 to 22, controlling general body traits unrelated to sex), and 1 pair is the <strong>sex chromosomes</strong> (XX in females, XY in males).</p>
       <table style="width:100%; border-collapse:collapse; margin:0; font-size:13px;">
         <thead>
           <tr style="background:var(--teal-soft);">
             <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Feature</th>
             <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Autosomes</th>
             <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Sex Chromosomes</th>
           </tr>
         </thead>
         <tbody>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Number in humans</td><td style="padding:8px 10px; border:1px solid var(--line);">22 pairs (44 total)</td><td style="padding:8px 10px; border:1px solid var(--line);">1 pair (2 total)</td></tr>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Function</td><td style="padding:8px 10px; border:1px solid var(--line);">Control general body traits</td><td style="padding:8px 10px; border:1px solid var(--line);">Determine biological sex</td></tr>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Same in both sexes?</td><td style="padding:8px 10px; border:1px solid var(--line);">Yes, identical pair types in males and females</td><td style="padding:8px 10px; border:1px solid var(--line);">No — XX in females, XY in males</td></tr>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Inheritance pattern</td><td style="padding:8px 10px; border:1px solid var(--line);">Usually simple dominant/recessive patterns</td><td style="padding:8px 10px; border:1px solid var(--line);">Follows sex-linked inheritance rules (covered later)</td></tr>
         </tbody>
       </table>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Special Chromosome Types</h4>
       <p style="margin:0 0 8px;">Beyond the standard chromosomes found in most dividing cells, a few unusual types appear in specific organisms or tissues, each with a distinct structure and job.</p>
       <ul style="margin:0; padding-left:18px;">
         <li><strong>Polytene chromosomes:</strong> giant chromosomes formed when DNA replicates repeatedly without the cell dividing (a process called endomitosis), producing thick, banded structures visible even under low magnification — found famously in the salivary gland cells of fruit fly larvae, and historically very useful for early gene-mapping studies, since each visible band could sometimes be matched to a specific gene</li>
         <li><strong>Lampbrush chromosomes:</strong> unusually large chromosomes with loops extending outward like a bottle-brush, found in the developing egg cells (oocytes) of many vertebrates. Each loop represents a region of DNA being very actively transcribed, since the egg needs to stockpile large amounts of RNA and protein in advance, before fertilization, to support the earliest stages of embryo development</li>
         <li><strong>B chromosomes:</strong> extra, non-essential chromosomes found in some plants, insects, and fungi, in addition to the normal ("A") chromosome set — often not required for survival, don't reliably follow Mendelian inheritance patterns, and can even vary in number between individuals of the very same species</li>
       </ul>
       <p style="margin:10px 0 0;">What all three of these special types share is a departure from the "standard" compact, rod-shaped chromosome most students first picture — a reminder that chromosome structure can be adapted for very different biological jobs depending on what the cell actually needs at that moment.</p>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Human Karyotype — Putting It All Together</h4>
       <p style="margin:0 0 8px;">A <strong>karyotype</strong> is an organized visual profile of all the chromosomes in a cell, arranged in pairs by size, from largest (chromosome 1) to smallest (chromosome 21, oddly numbered smaller than 22 due to a historical naming error that was never corrected), followed by the sex chromosomes.</p>
       <div style="margin:0 0 10px; padding:12px 14px; background:var(--coral-soft); border-left:4px solid var(--coral); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Clinical Point</span>
         <p style="margin:6px 0 0; font-size:14px;">Karyotyping is a standard clinical test used to detect chromosomal abnormalities — an extra chromosome 21 (trisomy 21) causes Down syndrome, while a missing X chromosome (45,X) causes Turner syndrome. Both are visible simply by counting and examining chromosomes under a microscope.</p>
       </div>
       <p style="margin:0;">Some human acrocentric chromosomes (numbers 13, 14, 15, 21, and 22) carry a small extra segment beyond a secondary constriction, called a <strong>satellite</strong>. This region contains genes for ribosomal RNA and is known as the <strong>Nucleolar Organizer Region (NOR)</strong> — the site where the nucleolus reassembles after each cell division. Because these regions can occasionally join or exchange material between chromosomes, they are also clinically relevant to a specific type of chromosomal rearrangement called a Robertsonian translocation.</p>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Importance &amp; Applications</h4>
       <ul style="margin:0; padding-left:18px;">
         <li><strong>Biotechnology application:</strong> polytene chromosomes were historically used to physically map gene locations by matching visible banding patterns to specific traits, long before DNA sequencing existed</li>
         <li><strong>Medical applications:</strong> karyotyping (based on classifying chromosomes by size and centromere position) remains a first-line clinical test for suspected chromosomal disorders, and is also used prenatally to screen for conditions like Down syndrome</li>
         <li><strong>Agricultural applications:</strong> understanding B chromosomes and their irregular inheritance helps plant breeders predict unusual, non-Mendelian patterns sometimes seen in certain crop species</li>
         <li><strong>Research applications:</strong> lampbrush chromosomes remain a useful model for studying how a cell can massively ramp up gene transcription at specific loci, which has informed broader research into gene regulation</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Modern Developments &amp; Interesting Facts</h4>
       <p style="margin:0 0 8px;">Classical karyotyping (arranging stained chromosomes by eye under a microscope) has been supplemented by far more precise modern techniques. <strong>Chromosome banding</strong> (using stains like Giemsa, giving "G-banding") creates a unique striped pattern for each chromosome, making them individually identifiable. <strong>FISH (Fluorescence In Situ Hybridization)</strong> goes further, using glowing molecular probes to confirm the identity or count of a specific chromosome directly, which is faster and more precise than counting bands by eye.</p>
       <div style="margin:0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Interesting Fact</span>
         <p style="margin:6px 0 0; font-size:14px;">Polytene chromosomes in some fruit fly larvae can contain over 1,000 copies of the same DNA strand bundled together, making them roughly 100 times thicker than an ordinary chromosome — thick enough that Drosophila researchers were mapping genes to visible chromosome bands decades before anyone could read an actual DNA sequence.</p>
       </div>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Common Mistakes Students Make</h4>
       <ul style="margin:0 0 10px; padding-left:18px;">
         <li>Confusing acrocentric with telocentric — acrocentric chromosomes still have a very short second arm; telocentric chromosomes have essentially none</li>
         <li>Assuming all species have the same number of autosome pairs as humans (22) — this number varies widely between species</li>
         <li>Thinking B chromosomes are essential for survival — most organisms that carry them can survive perfectly well without them</li>
       </ul>
       <div style="margin:0; padding:12px 14px; background:var(--panel); border:1px dashed var(--line); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-soft); font-weight:600;">Memory Trick</span>
         <p style="margin:6px 0 0; font-size:14px;">Remember centromere position with "M-S-A-T" from most-centered to least-centered: <strong>M</strong>etacentric (middle) → <strong>S</strong>ubmetacentric (slightly off) → <strong>A</strong>crocentric (near the end) → <strong>T</strong>elocentric (at the tip).</p>
       </div>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Summary &amp; Key Points</h4>
       <ul style="margin:0; padding-left:18px;">
         <li>Chromosomes are classified by centromere position: metacentric, submetacentric, acrocentric, and telocentric</li>
         <li>Humans have 22 pairs of autosomes and 1 pair of sex chromosomes (XX or XY)</li>
         <li>Polytene and lampbrush chromosomes are unusually large, found in specific tissues (fly salivary glands, vertebrate oocytes)</li>
         <li>B chromosomes are extra, non-essential chromosomes found in some plants, insects, and fungi</li>
         <li>A karyotype arranges all chromosomes by size and shape and is used clinically to detect chromosomal disorders</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Glossary</h4>
       <ul style="margin:0; padding-left:18px;">
         <li><strong>Autosome:</strong> any chromosome that is not a sex chromosome</li>
         <li><strong>Karyotype:</strong> an organized visual profile of all chromosomes in a cell</li>
         <li><strong>Polytene chromosome:</strong> a giant, multi-stranded chromosome formed by repeated DNA replication without cell division</li>
         <li><strong>Lampbrush chromosome:</strong> a large, loop-covered chromosome found in vertebrate oocytes</li>
         <li><strong>B chromosome:</strong> an extra, non-essential chromosome found in addition to an organism's normal set</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Viva Questions</h4>
       <ol style="margin:0; padding-left:18px;">
         <li>List the four types of chromosomes based on centromere position.</li>
         <li>What is the difference between an autosome and a sex chromosome?</li>
         <li>Where are polytene chromosomes typically found, and why are they useful?</li>
         <li>What is a karyotype used for clinically?</li>
         <li>Are B chromosomes essential for an organism's survival?</li>
       </ol>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Previous Year University Questions</h4>
       <p style="margin:0 0 6px; font-weight:600; font-size:13.5px;">Short answer (5 marks)</p>
       <ul style="margin:0 0 10px; padding-left:18px;">
         <li>Classify chromosomes based on the position of the centromere.</li>
         <li>Write a note on polytene and lampbrush chromosomes.</li>
       </ul>
       <p style="margin:0 0 6px; font-weight:600; font-size:13.5px;">Very short answer (2 marks)</p>
       <ul style="margin:0; padding-left:18px;">
         <li>Define autosome.</li>
         <li>What is a karyotype?</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Practice MCQs</h4>
       <ol style="margin:0; padding-left:18px;">
         <li>A chromosome with a centrally located centromere is called: <strong>(a)</strong> Acrocentric <strong>(b)</strong> Telocentric <strong>(c)</strong> Metacentric <strong>(d)</strong> Submetacentric <br><em style="color:var(--teal);">Answer: (c)</em></li>
         <li>Humans have how many pairs of autosomes? <strong>(a)</strong> 20 <strong>(b)</strong> 22 <strong>(c)</strong> 23 <strong>(d)</strong> 46 <br><em style="color:var(--teal);">Answer: (b)</em></li>
         <li>Polytene chromosomes are typically found in: <strong>(a)</strong> Human blood cells <strong>(b)</strong> Fruit fly salivary glands <strong>(c)</strong> Plant roots <strong>(d)</strong> Bacterial cells <br><em style="color:var(--teal);">Answer: (b)</em></li>
         <li>An organized visual profile of all chromosomes in a cell is called a: <strong>(a)</strong> Genome <strong>(b)</strong> Genotype <strong>(c)</strong> Karyotype <strong>(d)</strong> Phenotype <br><em style="color:var(--teal);">Answer: (c)</em></li>
         <li>Which chromosome type has essentially only one arm? <strong>(a)</strong> Metacentric <strong>(b)</strong> Submetacentric <strong>(c)</strong> Acrocentric <strong>(d)</strong> Telocentric <br><em style="color:var(--teal);">Answer: (d)</em></li>
       </ol>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Frequently Asked Questions</h4>
       <p style="margin:0 0 8px;"><strong>Q: Do all organisms have sex chromosomes?</strong><br>No — many organisms (like most plants and some reptiles) determine sex through other mechanisms, such as temperature during development, rather than through a distinct pair of sex chromosomes.</p>
       <p style="margin:0;"><strong>Q: Why is chromosome 21 the smallest but not numbered last?</strong><br>Human chromosomes were originally numbered based on estimated size using early microscopy, and chromosome 21 was later found to be slightly smaller than chromosome 22 — but the original numbering was kept unchanged for consistency.</p>`,

      /* ===================== TOPIC 10 — CELL CYCLE ===================== */

      `<div style="margin-bottom:4px;"><span style="font-family:var(--mono); font-size:11px; color:var(--teal); text-transform:uppercase; letter-spacing:0.08em;">Topic 10 of 31</span></div>
       <h4 style="color:var(--teal-deep); font-size:16px; margin:0 0 10px;">Cell Cycle</h4>
       <p style="margin:0 0 10px;">A cell doesn't simply "decide" to divide the moment it feels like it. Division is the final step of an orderly, tightly-timed sequence of growth and preparation — and if any step in that sequence goes wrong, the consequences can range from a wasted cell to cancer. The cell cycle is the name for this entire sequence, and understanding its phases is essential before you can properly understand mitosis and meiosis, covered in the next two topics.</p>
       <div style="margin:10px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Definition</span>
         <p style="margin:6px 0 0; font-size:14px;">The cell cycle is the ordered series of events — growth, DNA replication, and division — that a cell goes through from the moment it is formed until it produces two new daughter cells.</p>
       </div>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Historical Background</h4>
       <p style="margin:0 0 8px;">Chromosome behavior during division (mitosis) was described as far back as the 1880s by <strong>Walther Flemming</strong>, but for decades scientists assumed the entire period between one division and the next ("interphase") was simply a resting phase with nothing important happening. This turned out to be completely wrong.</p>
       <p style="margin:0;">In 1953, <strong>Alma Howard and Stephen Pelc</strong> used radioactive labeling to track exactly when DNA was being copied in dividing cells. They discovered that DNA replication happens only during a specific window within interphase — not throughout it, and not during division itself. This finding led them to divide the cell cycle into the now-standard phases: <strong>G1, S, G2, and M</strong>.</p>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">The Four Phases of the Cell Cycle</h4>
       <div style="margin:10px 0; padding:16px; border:1px solid var(--line); border-radius:10px; background:#fff; overflow-x:auto;">
         <div style="display:flex; min-width:420px; border-radius:8px; overflow:hidden; font-size:12px; text-align:center; color:#fff;">
           <div style="flex:4; background:var(--teal); padding:12px 4px;">G1<br><span style="font-size:10.5px; opacity:0.85;">Cell growth</span></div>
           <div style="flex:3; background:var(--teal-deep); padding:12px 4px;">S<br><span style="font-size:10.5px; opacity:0.85;">DNA replication</span></div>
           <div style="flex:2; background:var(--teal); padding:12px 4px;">G2<br><span style="font-size:10.5px; opacity:0.85;">Prepare to divide</span></div>
           <div style="flex:1.2; background:var(--coral); padding:12px 4px;">M<br><span style="font-size:10.5px; opacity:0.85;">Divide</span></div>
         </div>
         <p style="margin:10px 0 0; font-size:11.5px; text-align:center; color:var(--ink-soft);">G1, S, and G2 together make up interphase — by far the longest part of the cycle</p>
       </div>
       <ul style="margin:10px 0 0; padding-left:18px;">
         <li><strong>G1 phase (Gap 1):</strong> the cell grows in size, produces proteins and organelles, and carries out its normal, everyday functions</li>
         <li><strong>S phase (Synthesis):</strong> the cell's entire DNA content is precisely replicated, so each chromosome now consists of two identical sister chromatids</li>
         <li><strong>G2 phase (Gap 2):</strong> the cell continues growing and produces the specific proteins needed for division, such as components of the mitotic spindle</li>
         <li><strong>M phase (Mitosis):</strong> the replicated chromosomes are separated into two identical nuclei, followed by cytokinesis — the physical splitting of the cytoplasm into two separate daughter cells</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">The G0 Phase — Taking a Break From the Cycle</h4>
       <p style="margin:0 0 8px;">Not every cell is constantly cycling. Many cells exit the active cycle entirely and enter a resting state called <strong>G0</strong>, branching off from G1. Cells in G0 are metabolically active and carry out their normal jobs, but are not preparing to divide.</p>
       <ul style="margin:0; padding-left:18px;">
         <li><strong>Permanently in G0:</strong> most mature nerve cells and heart muscle cells, which rarely or never divide again after early development</li>
         <li><strong>Temporarily in G0:</strong> many cells (like liver cells) that can re-enter the active cycle later if the body needs more of them, such as after an injury</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Regulation — Cyclins, CDKs, and Checkpoints</h4>
       <p style="margin:0 0 10px;">The cell cycle isn't left to chance — it's controlled by a strict internal quality-control system, built around two families of proteins working together.</p>
       <ul style="margin:0 0 10px; padding-left:18px;">
         <li><strong>Cyclins:</strong> proteins whose concentration rises and falls at specific points in the cycle, acting as timing signals</li>
         <li><strong>Cyclin-Dependent Kinases (CDKs):</strong> enzymes that stay at a fairly constant level, but are only switched on when bound to the correct cyclin — this partnership is what actually drives the cell from one phase into the next</li>
       </ul>
       <div style="margin:10px 0; padding:16px; border:1px solid var(--line); border-radius:10px; background:#fff; overflow-x:auto;">
         <div style="display:flex; align-items:center; gap:6px; min-width:520px;">
           <div style="flex:1; text-align:center; padding:8px 4px; background:var(--teal-soft); border-radius:8px; font-size:11px; font-weight:600; color:var(--teal-deep);">G1 checkpoint<br><span style="font-weight:400; font-size:10px;">"Is the cell big enough &amp; healthy?"</span></div>
           <span style="font-size:16px; color:var(--ink-soft);">→</span>
           <div style="flex:1; text-align:center; padding:8px 4px; background:var(--coral-soft); border-radius:8px; font-size:11px; font-weight:600; color:#A8402C;">G2 checkpoint<br><span style="font-weight:400; font-size:10px;">"Was DNA copied correctly?"</span></div>
           <span style="font-size:16px; color:var(--ink-soft);">→</span>
           <div style="flex:1; text-align:center; padding:8px 4px; background:var(--teal-soft); border-radius:8px; font-size:11px; font-weight:600; color:var(--teal-deep);">M (spindle) checkpoint<br><span style="font-weight:400; font-size:10px;">"Are chromosomes attached correctly?"</span></div>
         </div>
       </div>
       <p style="margin:0;">At each checkpoint, the cell effectively "pauses" to verify everything is in order before proceeding. If damage or an error is detected, the cycle halts, giving repair mechanisms a chance to fix the problem — or, if the damage is too severe, triggering the cell to self-destruct via apoptosis rather than risk passing on faulty genetic material.</p>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Interphase vs M Phase</h4>
       <table style="width:100%; border-collapse:collapse; margin:0; font-size:13px;">
         <thead>
           <tr style="background:var(--teal-soft);">
             <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Feature</th>
             <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Interphase (G1, S, G2)</th>
             <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">M Phase</th>
           </tr>
         </thead>
         <tbody>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Duration</td><td style="padding:8px 10px; border:1px solid var(--line);">Longest part of the cycle (~90%)</td><td style="padding:8px 10px; border:1px solid var(--line);">Shortest part of the cycle</td></tr>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Main activity</td><td style="padding:8px 10px; border:1px solid var(--line);">Growth and DNA replication</td><td style="padding:8px 10px; border:1px solid var(--line);">Chromosome separation and cell division</td></tr>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Chromosomes visible as distinct rods?</td><td style="padding:8px 10px; border:1px solid var(--line);">No — chromatin is decondensed</td><td style="padding:8px 10px; border:1px solid var(--line);">Yes — tightly condensed</td></tr>
           <tr><td style="padding:8px 10px; border:1px solid var(--line);">Number of daughter cells produced</td><td style="padding:8px 10px; border:1px solid var(--line);">None (preparation only)</td><td style="padding:8px 10px; border:1px solid var(--line);">Two, at the end of this phase</td></tr>
         </tbody>
       </table>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Importance &amp; Clinical Significance</h4>
       <div style="margin:0 0 10px; padding:12px 14px; background:var(--coral-soft); border-left:4px solid var(--coral); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Clinical Point</span>
         <p style="margin:6px 0 0; font-size:14px;">Cancer is, at its core, a disease of the cell cycle — cancerous cells typically carry mutations in genes that control cyclins, CDKs, or checkpoints (such as the tumor-suppressor gene <em>p53</em>, often called the "guardian of the genome"), allowing them to bypass quality-control checks and divide uncontrollably.</p>
       </div>
       <ul style="margin:0; padding-left:18px;">
         <li><strong>Medical applications:</strong> several modern cancer drugs, called CDK inhibitors (e.g. palbociclib), work by directly blocking the CDK enzymes that cancer cells rely on to keep dividing</li>
         <li><strong>Biotechnology application:</strong> cell cycle synchronization techniques are used in labs to bring a population of cells to the same phase at once, making experiments on cell division far easier to interpret</li>
         <li><strong>Industrial/research applications:</strong> flow cytometry, a lab technique that measures a cell's DNA content, is routinely used to determine what fraction of a cell population sits in G1, S, or G2/M at any given time</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Modern Developments &amp; Interesting Facts</h4>
       <p style="margin:0 0 8px;">The discovery of cyclins and CDKs (by Tim Hunt, Paul Nurse, and Leland Hartwell) was significant enough to earn a shared Nobel Prize in 2001. Their combined work showed that the same basic cyclin-CDK control system, with only minor variations, runs the cell cycle in organisms as different as yeast and humans.</p>
       <div style="margin:0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Interesting Fact</span>
         <p style="margin:6px 0 0; font-size:14px;">An adult human body produces roughly 200 billion new cells every single day just to replace worn-out ones — nearly all of that turnover is governed by the same G1-S-G2-M cycle described in this topic, running in trillions of cells simultaneously.</p>
       </div>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Common Mistakes Students Make</h4>
       <ul style="margin:0 0 10px; padding-left:18px;">
         <li>Thinking interphase is a "resting" phase — it's actually the busiest part of the cycle in terms of growth and DNA replication</li>
         <li>Assuming DNA replication happens throughout interphase — it is restricted specifically to the S phase</li>
         <li>Confusing G0 with G1 — G0 is a separate, non-dividing branch off the cycle, not simply an early part of G1</li>
         <li>Forgetting that checkpoints can trigger apoptosis, not just a pause — severely damaged cells are often eliminated entirely rather than repaired</li>
       </ul>
       <div style="margin:0; padding:12px 14px; background:var(--panel); border:1px dashed var(--line); border-radius:8px;">
         <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-soft); font-weight:600;">Memory Trick</span>
         <p style="margin:6px 0 0; font-size:14px;">Remember the phase order with "Grow-Synthesize-Grow-Multiply": <strong>G</strong>1 (grow) → <strong>S</strong> (synthesize/copy DNA) → <strong>G</strong>2 (grow more) → <strong>M</strong> (multiply into two cells).</p>
       </div>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Summary &amp; Key Points</h4>
       <ul style="margin:0; padding-left:18px;">
         <li>The cell cycle consists of interphase (G1, S, G2) followed by M phase (mitosis and cytokinesis)</li>
         <li>Howard and Pelc (1953) first showed DNA replication is restricted to the S phase, not spread across all of interphase</li>
         <li>G0 is a separate resting state some cells enter, either permanently or temporarily</li>
         <li>Cyclins and CDKs work together to drive the cell through each phase, monitored by G1, G2, and spindle checkpoints</li>
         <li>Cancer commonly arises from mutations that disable these checkpoints, allowing uncontrolled division</li>
         <li>CDK-inhibiting drugs and flow cytometry are direct, practical applications of cell cycle biology</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Glossary</h4>
       <ul style="margin:0; padding-left:18px;">
         <li><strong>Interphase:</strong> the combined G1, S, and G2 phases between one division and the next</li>
         <li><strong>Cyclin:</strong> a protein whose level rises and falls to help drive the cell cycle forward</li>
         <li><strong>Cyclin-dependent kinase (CDK):</strong> an enzyme activated by binding to a cyclin, driving progress through the cycle</li>
         <li><strong>Checkpoint:</strong> a quality-control point in the cell cycle where the cell verifies conditions before proceeding</li>
         <li><strong>Cytokinesis:</strong> the physical division of the cytoplasm into two daughter cells, following nuclear division</li>
         <li><strong>Flow cytometry:</strong> a technique that measures cellular DNA content to determine a cell's cycle phase</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Viva Questions</h4>
       <ol style="margin:0; padding-left:18px;">
         <li>List the four phases of the cell cycle in order.</li>
         <li>What did Howard and Pelc discover in 1953?</li>
         <li>What is the difference between G0 and G1?</li>
         <li>How do cyclins and CDKs work together to regulate the cycle?</li>
         <li>Name the three main cell cycle checkpoints and what each one verifies.</li>
         <li>Why is cancer often described as a disease of the cell cycle?</li>
       </ol>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Previous Year University Questions</h4>
       <p style="margin:0 0 6px; font-weight:600; font-size:13.5px;">Long answer (10 marks)</p>
       <ul style="margin:0 0 10px; padding-left:18px;">
         <li>Describe the phases of the cell cycle and their significance.</li>
         <li>Explain the role of cyclins and CDKs in cell cycle regulation.</li>
       </ul>
       <p style="margin:0 0 6px; font-weight:600; font-size:13.5px;">Short answer (5 marks)</p>
       <ul style="margin:0 0 10px; padding-left:18px;">
         <li>Write a short note on the G0 phase.</li>
         <li>Explain the significance of cell cycle checkpoints.</li>
       </ul>
       <p style="margin:0 0 6px; font-weight:600; font-size:13.5px;">Very short answer (2 marks)</p>
       <ul style="margin:0; padding-left:18px;">
         <li>Define cytokinesis.</li>
         <li>In which phase does DNA replication occur?</li>
       </ul>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Practice MCQs</h4>
       <ol style="margin:0; padding-left:18px;">
         <li>DNA replication occurs during: <strong>(a)</strong> G1 phase <strong>(b)</strong> S phase <strong>(c)</strong> G2 phase <strong>(d)</strong> M phase <br><em style="color:var(--teal);">Answer: (b)</em></li>
         <li>Interphase consists of: <strong>(a)</strong> G1, S, G2 <strong>(b)</strong> G1, M, G2 <strong>(c)</strong> S, M only <strong>(d)</strong> G0, G1 only <br><em style="color:var(--teal);">Answer: (a)</em></li>
         <li>Cells that permanently exit the cell cycle enter: <strong>(a)</strong> S phase <strong>(b)</strong> G0 phase <strong>(c)</strong> G2 phase <strong>(d)</strong> M phase <br><em style="color:var(--teal);">Answer: (b)</em></li>
         <li>CDKs are activated by binding to: <strong>(a)</strong> DNA <strong>(b)</strong> Cyclins <strong>(c)</strong> Ribosomes <strong>(d)</strong> Histones <br><em style="color:var(--teal);">Answer: (b)</em></li>
         <li>The 2001 Nobel Prize for discovering cyclins/CDKs was shared by: <strong>(a)</strong> Watson &amp; Crick <strong>(b)</strong> Hunt, Nurse &amp; Hartwell <strong>(c)</strong> Temin &amp; Baltimore <strong>(d)</strong> Beadle &amp; Tatum <br><em style="color:var(--teal);">Answer: (b)</em></li>
         <li>A tumor-suppressor gene often called the "guardian of the genome" is: <strong>(a)</strong> <em>p53</em> <strong>(b)</strong> <em>BRCA1</em> <strong>(c)</strong> <em>RAS</em> <strong>(d)</strong> <em>MYC</em> <br><em style="color:var(--teal);">Answer: (a)</em></li>
       </ol>`,

      `<h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Frequently Asked Questions</h4>
       <p style="margin:0 0 8px;"><strong>Q: Is G0 a permanent state?</strong><br>Not always — nerve and muscle cells typically stay in G0 permanently, but some cells (like liver cells) can re-enter the active cycle if the body needs more of them.</p>
       <p style="margin:0 0 8px;"><strong>Q: Why does the cell need separate G1 and G2 phases instead of replicating DNA right after mitosis?</strong><br>The gap phases give the cell time to grow, produce necessary proteins, and pass quality-control checkpoints before committing to the next major step, reducing the risk of dividing before it's actually ready.</p>
       <p style="margin:0;"><strong>Q: Do all cells in the body divide at the same rate?</strong><br>No — cell division rates vary enormously by tissue type; skin and gut lining cells divide frequently, while most nerve cells rarely or never divide again after early development.</p>`,

    ] },
  { tag:'Unit 03', title:'Molecular Biology', desc:'DNA, RNA, and the central dogma in detail.',
    topics:[`<div style="margin-bottom:4px;"><span style="font-family:var(--mono); font-size:11px; color:var(--teal); text-transform:uppercase; letter-spacing:0.08em;">Topic 1 of 10</span></div> <h4 style="color:var(--teal-deep); font-size:16px; margin:0 0 10px;">Introduction to Molecular Biology</h4> <p style="margin:0 0 10px;">In Unit 2, you learned that genes control traits and that chromosomes carry those genes. But none of that explains the actual mechanics — how a gene physically gets "read," or how a cell turns a stretch of DNA into a working protein that can digest sugar, fight an infection, or build a muscle fiber. That is exactly the gap molecular biology fills. It zooms in past the chromosome, right down to the level of individual molecules, to explain how genetic information is stored, copied, read, and used.</p> <div style="margin:10px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;"> <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Definition</span> <p style="margin:6px 0 0; font-size:14px;">Molecular biology is the branch of biology that studies living processes at the level of molecules — particularly DNA, RNA, and proteins — focusing on how genetic information is stored, replicated, transcribed, and translated into function.</p> </div> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Historical Background</h4> <p style="margin:0 0 8px;">The term "molecular biology" was coined in 1938 by <strong>Warren Weaver</strong>, a scientist at the Rockefeller Foundation, to describe a new kind of research that used physics and chemistry to answer biological questions. But the field only truly took off after 1953, when <strong>Watson and Crick</strong> described the double-helix structure of DNA — a discovery that, for the first time, showed exactly how genetic information could be physically copied and stored.</p> <p style="margin:0;">From there, the field moved quickly: the genetic code was cracked in the 1960s, recombinant DNA technology arrived in the 1970s, and by the 1980s, molecular biology had become the central toolkit of modern biotechnology, medicine, and agriculture.</p> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Detailed Explanation — What Molecular Biology Actually Studies</h4> <p style="margin:0 0 8px;">Every living cell runs on the same basic instruction system: DNA stores the instructions, RNA carries a working copy of those instructions, and protein carries the instructions out. Molecular biology studies each link in that chain in detail — not just what these molecules look like, but exactly how they interact, step by step, at the level of individual chemical bonds.</p> <p style="margin:0;">This is different from simply memorizing that "DNA makes protein." Molecular biology asks precise, mechanical questions: which enzyme unwinds the DNA helix? How does the cell know exactly where a gene begins and ends? How does a three-letter code get translated into one specific amino acid, every single time? Answering these questions is what makes molecular biology a foundation subject, not just a supporting one.</p> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Structure — The Three Core Molecules</h4> <p style="margin:0 0 10px;">Nearly everything in this unit is really a detailed study of three molecule types and how they relate to one another.</p> <div style="margin:10px 0; padding:16px; border:1px solid var(--line); border-radius:10px; background:var(--panel); overflow-x:auto;"> <div style="display:flex; gap:10px; min-width:460px;"> <div style="flex:1; text-align:center; padding:10px 6px; background:var(--teal-soft); border-radius:8px;"> <div style="display:flex; justify-content:center; gap:3px; margin-bottom:6px;"> <div style="width:8px; height:34px; background:var(--teal-deep); border-radius:3px;"></div> <div style="width:8px; height:34px; background:var(--teal-deep); border-radius:3px;"></div> </div> <span style="font-size:12.5px; font-weight:600; color:var(--teal-deep);">DNA</span><br> <span style="font-size:10.5px; color:var(--ink-soft);">Double strand, storage</span> </div> <div style="flex:1; text-align:center; padding:10px 6px; background:var(--teal-soft); border-radius:8px;"> <div style="display:flex; justify-content:center; margin-bottom:6px;"> <div style="width:8px; height:34px; background:var(--teal); border-radius:3px;"></div> </div> <span style="font-size:12.5px; font-weight:600; color:var(--teal-deep);">RNA</span><br> <span style="font-size:10.5px; color:var(--ink-soft);">Single strand, messenger</span> </div> <div style="flex:1; text-align:center; padding:10px 6px; background:var(--coral-soft); border-radius:8px;"> <div style="display:flex; justify-content:center; gap:2px; margin-bottom:6px;"> <div style="width:9px; height:9px; border-radius:50%; background:var(--coral);"></div> <div style="width:9px; height:9px; border-radius:50%; background:var(--coral);"></div> <div style="width:9px; height:9px; border-radius:50%; background:var(--coral);"></div> <div style="width:9px; height:9px; border-radius:50%; background:var(--coral);"></div> </div> <span style="font-size:12.5px; font-weight:600; color:var(--coral);">Protein</span><br> <span style="font-size:10.5px; color:var(--ink-soft);">Chain of amino acids</span> </div> </div> <p style="margin:10px 0 0; font-size:11.5px; text-align:center; color:var(--ink-soft);">Three molecule types, three different jobs — storage, messaging, and function</p> </div> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Components of the Molecular Biology Toolkit</h4> <ul style="margin:0; padding-left:18px;"> <li><strong>Nucleic acids:</strong> DNA and RNA, the information-carrying molecules</li> <li><strong>Proteins:</strong> the functional end-products — enzymes, structural proteins, receptors</li> <li><strong>Enzymes:</strong> the molecular tools (polymerases, ligases, restriction enzymes) that read, copy, cut, and join nucleic acids</li> <li><strong>Ribosomes:</strong> the molecular machines that build proteins from RNA instructions</li> <li><strong>Vectors:</strong> carrier molecules (like plasmids) used to move DNA between organisms — central to recombinant DNA technology, covered later in this unit</li> </ul> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Classification — Branches of Molecular Biology</h4> <div style="margin:10px 0; padding:16px; border:1px solid var(--line); border-radius:10px; background:var(--panel);"> <div style="display:flex; justify-content:center;"> <div style="padding:8px 20px; background:var(--teal-deep); color:#fff; border-radius:8px; font-size:13px; font-weight:600;">Molecular Biology</div> </div> <div style="display:flex; justify-content:center;"> <div style="width:2px; height:14px; background:var(--line);"></div> </div> <div style="height:1px; background:var(--line); margin:0 8%;"></div> <div style="display:flex; justify-content:space-between; gap:6px; margin-top:14px; flex-wrap:wrap;"> <div style="flex:1; min-width:95px; text-align:center; padding:9px 4px; background:var(--teal-soft); border-radius:8px; font-size:11.5px; color:var(--teal-deep); font-weight:600;">DNA Structure &amp; Replication</div> <div style="flex:1; min-width:95px; text-align:center; padding:9px 4px; background:var(--teal-soft); border-radius:8px; font-size:11.5px; color:var(--teal-deep); font-weight:600;">RNA &amp; Transcription</div> <div style="flex:1; min-width:95px; text-align:center; padding:9px 4px; background:var(--teal-soft); border-radius:8px; font-size:11.5px; color:var(--teal-deep); font-weight:600;">Genetic Code &amp; Translation</div> <div style="flex:1; min-width:95px; text-align:center; padding:9px 4px; background:var(--teal-soft); border-radius:8px; font-size:11.5px; color:var(--teal-deep); font-weight:600;">Gene Regulation</div> <div style="flex:1; min-width:95px; text-align:center; padding:9px 4px; background:var(--teal-soft); border-radius:8px; font-size:11.5px; color:var(--teal-deep); font-weight:600;">Recombinant DNA Tech</div> </div> </div> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Mechanism — The Central Dogma</h4> <p style="margin:0 0 10px;">Almost everything in this unit builds on one simple flow of information, first proposed by Francis Crick in 1958 and known as the <strong>Central Dogma of Molecular Biology</strong>.</p> <div style="margin:10px 0; padding:16px; border:1px solid var(--line); border-radius:10px; background:var(--panel); overflow-x:auto;"> <div style="display:flex; align-items:center; gap:6px; min-width:460px; justify-content:center;"> <div style="flex:1; text-align:center; padding:10px 6px; background:var(--teal-soft); border-radius:8px;"> <span style="font-size:13px; font-weight:600; color:var(--teal-deep);">DNA</span><br> <span style="font-size:11px; color:var(--ink-soft);">Storage</span> </div> <span style="font-size:18px; color:var(--ink-soft);">→</span> <div style="flex:1; text-align:center; padding:10px 6px; background:var(--teal-soft); border-radius:8px;"> <span style="font-size:13px; font-weight:600; color:var(--teal-deep);">RNA</span><br> <span style="font-size:11px; color:var(--ink-soft);">Messenger</span> </div> <span style="font-size:18px; color:var(--ink-soft);">→</span> <div style="flex:1; text-align:center; padding:10px 6px; background:var(--coral-soft); border-radius:8px;"> <span style="font-size:13px; font-weight:600; color:var(--coral);">Protein</span><br> <span style="font-size:11px; color:var(--ink-soft);">Function</span> </div> </div> <p style="margin:10px 0 0; font-size:11.5px; text-align:center; color:var(--ink-soft);">DNA is transcribed into RNA, and RNA is translated into protein</p> </div> <p style="margin:0;">Two labeled arrows in this diagram deserve their own names: the DNA→RNA step is called <strong>transcription</strong>, and the RNA→protein step is called <strong>translation</strong>. Later research also found an exception — an RNA→DNA step called <strong>reverse transcription</strong>, used by retroviruses like HIV — but the forward flow shown above remains the default path for nearly all cellular life.</p> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Stepwise Process — How a Molecular Biologist Studies a Gene</h4> <ul style="margin:0; padding-left:18px;"> <li><strong>Step 1:</strong> Isolate the DNA or RNA of interest from cells or tissue</li> <li><strong>Step 2:</strong> Amplify it using PCR, or clone it into a vector, to get enough material to work with</li> <li><strong>Step 3:</strong> Sequence or analyze the isolated DNA/RNA to read its exact composition</li> <li><strong>Step 4:</strong> Study or manipulate its expression — for example, by inserting it into a host cell to see what protein it produces</li> <li><strong>Step 5:</strong> Interpret the results to answer a biological question, or apply the finding to a real product (a diagnostic test, a therapy, an engineered crop)</li> </ul> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Important Enzymes &amp; Proteins You Will Meet in This Unit</h4> <ul style="margin:0; padding-left:18px;"> <li><strong>DNA polymerase:</strong> copies DNA during replication</li> <li><strong>RNA polymerase:</strong> builds an RNA strand during transcription</li> <li><strong>Ligase:</strong> joins broken pieces of DNA together</li> <li><strong>Helicase:</strong> unwinds the DNA double helix so it can be copied or read</li> <li><strong>Restriction enzymes:</strong> cut DNA at specific sequences, essential for recombinant DNA technology</li> <li><strong>Ribosome:</strong> the molecular machine that carries out translation</li> </ul> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Molecular Biology vs Classical Genetics vs Biochemistry</h4> <table style="width:100%; border-collapse:collapse; margin:0; font-size:13px;"> <thead> <tr style="background:var(--teal-soft);"> <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Feature</th> <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Classical Genetics</th> <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Molecular Biology</th> <th style="text-align:left; padding:8px 10px; border:1px solid var(--line);">Biochemistry</th> </tr> </thead> <tbody> <tr><td style="padding:8px 10px; border:1px solid var(--line);">Level studied</td><td style="padding:8px 10px; border:1px solid var(--line);">Whole organism, traits</td><td style="padding:8px 10px; border:1px solid var(--line);">DNA, RNA, proteins</td><td style="padding:8px 10px; border:1px solid var(--line);">Chemical reactions in cells</td></tr> <tr><td style="padding:8px 10px; border:1px solid var(--line);">Main question asked</td><td style="padding:8px 10px; border:1px solid var(--line);">How are traits inherited?</td><td style="padding:8px 10px; border:1px solid var(--line);">How is genetic information used?</td><td style="padding:8px 10px; border:1px solid var(--line);">How do molecules react and interact?</td></tr> <tr><td style="padding:8px 10px; border:1px solid var(--line);">Key tools</td><td style="padding:8px 10px; border:1px solid var(--line);">Breeding, statistics</td><td style="padding:8px 10px; border:1px solid var(--line);">PCR, sequencing, cloning</td><td style="padding:8px 10px; border:1px solid var(--line);">Enzyme assays, chromatography</td></tr> </tbody> </table> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Advantages &amp; Disadvantages of Studying Life at the Molecular Level</h4> <p style="margin:0 0 8px;"><strong>Advantages:</strong> molecular-level study gives extremely precise, testable answers, works the same way across almost all living organisms (making techniques transferable between species), and directly enables manipulation — you can copy, cut, edit, or insert genetic material once you understand it at this level.</p> <p style="margin:0;"><strong>Disadvantages:</strong> molecular techniques often need expensive, specialized equipment; studying isolated molecules can miss the bigger picture of how a whole organism behaves in its environment; and the same precision that makes gene editing powerful also raises ethical questions about how far that manipulation should go.</p> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Biotechnology Applications</h4> <div style="margin:0 0 10px; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;"> <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Biotechnology Application</span> <p style="margin:6px 0 0; font-size:14px;">Every biotechnology product you can think of — genetically modified crops, recombinant vaccines, gene therapy, industrial enzymes — is built directly on molecular biology's core techniques: cutting, copying, reading, and rewriting DNA and RNA.</p> </div> <ul style="margin:0; padding-left:18px;"> <li>PCR (Polymerase Chain Reaction) — copies a specific piece of DNA millions of times, used in COVID-19 testing</li> <li>Insulin production — bacteria genetically engineered to produce human insulin at industrial scale</li> <li>DNA fingerprinting — used in forensic investigations and paternity testing</li> <li>mRNA vaccines — deliver genetic instructions for a cell to build a piece of a virus, training the immune system</li> </ul> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Clinical Significance</h4> <div style="margin:0; padding:12px 14px; background:var(--coral-soft); border-left:4px solid var(--coral); border-radius:8px;"> <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--coral); font-weight:600;">Clinical Point</span> <p style="margin:6px 0 0; font-size:14px;">Molecular diagnostic tests — including RT-PCR for viral infections and genetic testing for inherited disorders — all depend on understanding exactly how DNA and RNA behave, which is precisely what this unit covers.</p> </div> <div style="margin:12px 0 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;"> <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Important</span> <p style="margin:6px 0 0; font-size:14px;">Every later topic in this unit — replication, transcription, translation, gene regulation — is really just a detailed zoom-in on one arrow of the Central Dogma diagram above. Keep that diagram in mind as your map for the rest of Unit 3.</p> </div> <div style="margin:12px 0 0; padding:12px 14px; background:var(--panel); border:1px dashed var(--line); border-radius:8px;"> <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-soft); font-weight:600;">Memory Trick</span> <p style="margin:6px 0 0; font-size:14px;">Remember the Central Dogma with "Don't Read Papers" — <strong>D</strong>NA → <strong>R</strong>NA → <strong>P</strong>rotein.</p> </div> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 8px;">Common Mistakes Students Make</h4> <ul style="margin:0 0 10px; padding-left:18px;"> <li>Thinking molecular biology and genetics are the same subject — genetics studies inheritance patterns at the organism level, molecular biology studies the molecules that make heredity possible</li> <li>Assuming the Central Dogma has no exceptions — reverse transcription (RNA → DNA) is a well-documented exception used by retroviruses</li> <li>Believing transcription and translation happen in the same location in all cells — in eukaryotes they are separated by the nuclear membrane, while in bacteria they occur together in the cytoplasm</li> </ul> <div style="margin:0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;"> <span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Quick Revision</span> <p style="margin:6px 0 0; font-size:14px;">Molecular biology = study of DNA, RNA, and protein. Central Dogma = DNA → RNA → Protein. Transcription = DNA to RNA. Translation = RNA to protein. Reverse transcription = RNA to DNA (retroviruses only).</p> </div> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Summary</h4> <ul style="margin:0; padding-left:18px;"> <li>Molecular biology studies life at the level of DNA, RNA, and proteins</li> <li>The term was coined by Warren Weaver in 1938; the field accelerated after Watson and Crick's 1953 DNA structure discovery</li> <li>The Central Dogma (DNA → RNA → Protein) is the organizing framework for the entire unit</li> <li>Transcription converts DNA to RNA; translation converts RNA to protein</li> <li>Reverse transcription is a known exception, used by retroviruses like HIV</li> <li>Molecular biology is the direct foundation of modern biotechnology, medicine, and agriculture</li> </ul> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Key Points</h4> <ul style="margin:0; padding-left:18px;"> <li>Three core molecules: DNA (storage), RNA (messenger), protein (function)</li> <li>Five major branches: DNA structure/replication, RNA/transcription, genetic code/translation, gene regulation, recombinant DNA technology</li> <li>Key enzymes: DNA polymerase, RNA polymerase, ligase, helicase, restriction enzymes</li> </ul> <h4 style="color:var(--teal-deep); font-size:15px; margin:0 0 10px;">Glossary</h4> <ul style="margin:0; padding-left:18px;"> <li><strong>Central Dogma:</strong> the principle that genetic information flows from DNA to RN`] },
