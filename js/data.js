...
`
<div style="margin-bottom:4px;"><span style="font-family:var(--mono); font-size:11px; color:var(--teal); text-transform:uppercase; letter-spacing:0.08em;">Topic 9 of 31</span></div>

<h4 style="color:var(--teal-deep); font-size:16px; margin:0 0 10px;">Chromosomal Aberrations</h4>

<p style="margin:0 0 10px;">
Every normal human cell contains 46 chromosomes arranged into 23 pairs. These chromosomes carry thousands of genes that control growth, development, metabolism, and inheritance. During cell division, chromosomes are duplicated and equally distributed into daughter cells. However, errors may occur during meiosis or mitosis, leading to changes in chromosome number or chromosome structure. Such abnormalities are known as <strong>chromosomal aberrations</strong>.
</p>

<p style="margin:0 0 10px;">
Chromosomal aberrations are among the major causes of genetic disorders, congenital abnormalities, infertility, spontaneous abortions, and several types of cancers. Some chromosomal abnormalities are inherited from parents, while others arise spontaneously because of mistakes during cell division or exposure to mutagens such as radiation and chemicals.
</p>

<p style="margin:0;">
The study of chromosomal aberrations is an important branch of cytogenetics because it helps scientists understand the causes of many genetic diseases, diagnose chromosomal disorders before birth, and develop better treatment strategies through modern biotechnology.
</p>

<div style="margin:12px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Definition</span>

<p style="margin:6px 0 0; font-size:14px;">
<b>Chromosomal aberration</b> is a permanent alteration in the number or structure of chromosomes that may affect the normal functioning of genes and lead to genetic disorders or developmental abnormalities.
</p>
</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Historical Background</h4>

<p style="margin:0 0 8px;">
The relationship between chromosomes and inherited diseases became clear only after the development of modern microscopes and chromosome staining techniques. During the early twentieth century, scientists recognized that chromosomes carried hereditary information, but identifying abnormal chromosomes remained difficult.
</p>

<p style="margin:0 0 8px;">
In 1956, <strong>Joe Hin Tjio</strong> and <strong>Albert Levan</strong> accurately established that the normal human chromosome number is <strong>46</strong>. This discovery laid the foundation for human cytogenetics.
</p>

<p style="margin:0 0 8px;">
A few years later, in 1959, the French geneticist <strong>Jérôme Lejeune</strong> discovered that children with Down syndrome possess an extra chromosome 21. This was the first evidence that a human disease could result from a chromosomal abnormality.
</p>

<p style="margin:0;">
Since then, advances such as karyotyping, fluorescence in situ hybridization (FISH), comparative genomic hybridization (CGH), and DNA sequencing have enabled scientists to detect chromosomal abnormalities with remarkable accuracy.
</p>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Normal Human Karyotype</h4>

<p style="margin:0 0 8px;">
A <strong>karyotype</strong> is the complete set of chromosomes arranged in pairs according to their size, shape, and centromere position. Human beings normally possess <strong>46 chromosomes</strong>, organized into <strong>23 pairs</strong>.
</p>

<ul style="margin:0; padding-left:18px;">
<li>22 pairs are called <strong>Autosomes</strong>.</li>
<li>1 pair consists of the <strong>Sex Chromosomes</strong>.</li>
<li>Females possess <strong>XX</strong> chromosomes.</li>
<li>Males possess <strong>XY</strong> chromosomes.</li>
</ul>

<div style="margin:12px 0; padding:14px; border:1px solid var(--line); border-radius:10px; background:#fff; overflow-x:auto;">

<div style="display:flex; flex-wrap:wrap; justify-content:center; gap:8px;">

<div style="padding:8px 12px; background:var(--teal-soft); border-radius:6px;">22 Pairs<br><b>Autosomes</b></div>

<div style="padding:8px 12px; background:var(--coral-soft); border-radius:6px;">1 Pair<br><b>Sex Chromosomes</b></div>

</div>

<p style="margin:10px 0 0; font-size:11.5px; text-align:center; color:var(--ink-soft);">
Normal Human Karyotype (46 = 44 Autosomes + XX/XY)
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Classification of Chromosomal Aberrations</h4>

<p style="margin:0 0 8px;">
Chromosomal abnormalities are broadly divided into two major categories depending on whether they affect chromosome number or chromosome structure.
</p>
...
<th style="border:1px solid var(--line); padding:8px;">Type</th>

<th style="border:1px solid var(--line); padding:8px;">Description</th>

<th style="border:1px solid var(--line); padding:8px;">Examples</th>
...
<td style="border:1px solid var(--line); padding:8px;"><b>Numerical Aberration</b></td>

<td style="border:1px solid var(--line); padding:8px;">Change in chromosome number.</td>

<td style="border:1px solid var(--line); padding:8px;">Down syndrome, Turner syndrome</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Structural Aberration</b></td>

<td style="border:1px solid var(--line); padding:8px;">Change in chromosome structure.</td>

<td style="border:1px solid var(--line); padding:8px;">Deletion, Duplication, Inversion, Translocation</td>
...
<div style="margin:12px 0; padding:12px 14px; background:var(--coral-soft); border-left:4px solid var(--coral); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Important</span>

<p style="margin:6px 0 0; font-size:14px;">
Remember that numerical abnormalities involve the gain or loss of entire chromosomes, whereas structural abnormalities involve changes in chromosome segments without necessarily altering the total chromosome number.
</p>

</div>
<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Numerical Chromosomal Aberrations</h4>

<p style="margin:0 0 10px;">
Numerical chromosomal aberrations occur when the total number of chromosomes changes due to errors during cell division. These abnormalities usually arise because chromosomes fail to separate properly during meiosis or mitosis, a phenomenon known as <strong>nondisjunction</strong>. As a result, daughter cells receive either extra chromosomes or fewer chromosomes than normal.
</p>

<p style="margin:0 0 10px;">
Numerical abnormalities are among the most common causes of spontaneous abortions, infertility, congenital birth defects, and developmental disorders. Depending on whether the entire chromosome set or only individual chromosomes are affected, numerical aberrations are classified into <strong>Euploidy</strong> and <strong>Aneuploidy</strong>.
</p>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Euploidy</h4>

<p style="margin:0 0 8px;">
Euploidy refers to a condition in which the complete set of chromosomes is increased or decreased. Instead of gaining or losing a single chromosome, the organism gains or loses an entire chromosome set.
</p>

<ul style="margin:0; padding-left:18px;">
<li><strong>Haploid (n)</strong> – One complete chromosome set (Gametes).</li>
<li><strong>Diploid (2n)</strong> – Two chromosome sets (Normal human cells).</li>
<li><strong>Triploid (3n)</strong> – Three chromosome sets.</li>
<li><strong>Tetraploid (4n)</strong> – Four chromosome sets.</li>
</ul>

<p style="margin:10px 0 0;">
Polyploid organisms are very common in plants and are often larger, stronger, and more resistant to environmental stress. However, polyploidy is generally lethal in humans and rarely survives beyond early embryonic development.
</p>

<div style="margin:12px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Biotechnology Note</span>

<p style="margin:6px 0 0; font-size:14px;">
Artificial polyploidy is induced in crop plants using chemicals such as <strong>colchicine</strong>. Polyploid plants often produce larger fruits, bigger flowers, and improved yield. Banana, wheat, cotton, and strawberry are common examples.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Aneuploidy</h4>

<p style="margin:0 0 10px;">
Aneuploidy is the gain or loss of one or more individual chromosomes rather than an entire chromosome set. It is the most common type of chromosomal abnormality observed in humans and is responsible for several well-known genetic disorders.
</p>
...
<th style="border:1px solid var(--line); padding:8px;">Condition</th>

<th style="border:1px solid var(--line); padding:8px;">Chromosome Number</th>

<th style="border:1px solid var(--line); padding:8px;">Meaning</th>
...
<td style="border:1px solid var(--line); padding:8px;"><strong>Monosomy</strong></td>

<td style="border:1px solid var(--line); padding:8px;">2n − 1</td>

<td style="border:1px solid var(--line); padding:8px;">One chromosome missing</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Trisomy</strong></td>

<td style="border:1px solid var(--line); padding:8px;">2n + 1</td>

<td style="border:1px solid var(--line); padding:8px;">One extra chromosome</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Tetrasomy</strong></td>

<td style="border:1px solid var(--line); padding:8px;">2n + 2</td>

<td style="border:1px solid var(--line); padding:8px;">Two extra chromosomes</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Nullisomy</strong></td>

<td style="border:1px solid var(--line); padding:8px;">2n − 2</td>

<td style="border:1px solid var(--line); padding:8px;">Pair of chromosomes absent</td>
...
<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Nondisjunction</h4>

<p style="margin:0 0 10px;">
The major cause of aneuploidy is <strong>nondisjunction</strong>, which is the failure of homologous chromosomes or sister chromatids to separate properly during cell division.
</p>

<div style="margin:14px 0; padding:14px; border:1px solid var(--line); border-radius:10px; background:#fff; overflow-x:auto;">

<div style="display:flex; justify-content:center; align-items:center; gap:16px; flex-wrap:wrap;">

<div style="text-align:center;">
<div style="padding:8px 12px; background:var(--teal-soft); border-radius:8px;">Normal Cell</div>
</div>

<div style="font-size:22px;">→</div>

<div style="text-align:center;">
<div style="padding:8px 12px; background:#FFE8C2; border-radius:8px;">Nondisjunction</div>
</div>
...
<div style="padding:8px 10px; background:#D9F8E6; border-radius:8px;">n+1</div>

<div style="padding:8px 10px; background:#FFD6D6; border-radius:8px;">n−1</div>

</div>

</div>

<p style="margin:12px 0 0; text-align:center; font-size:11.5px; color:var(--ink-soft);">
Failure of chromosome separation produces abnormal gametes containing extra or missing chromosomes.
</p>

</div>

<p style="margin:0 0 10px;">
If these abnormal gametes participate in fertilization, the resulting embryo will possess an abnormal chromosome number, leading to disorders such as Down syndrome, Turner syndrome, or Klinefelter syndrome.
</p>

<div style="margin:12px 0; padding:12px 14px; background:var(--coral-soft); border-left:4px solid var(--coral); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Clinical Importance</span>

<p style="margin:6px 0 0; font-size:14px;">
Maternal age is an important risk factor for chromosomal nondisjunction. Women above 35 years of age have a higher probability of producing gametes with abnormal chromosome numbers, increasing the risk of trisomy disorders.
</p>

</div>

<div style="margin:12px 0; padding:12px 14px; background:var(--panel); border:1px dashed var(--line); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-soft); font-weight:600;">Memory Trick</span>

<p style="margin:6px 0 0; font-size:14px;">
Remember:<br>
<strong>Euploidy = Entire chromosome set changes.</strong><br>
<strong>Aneuploidy = A few chromosomes change.</strong><br><br>

Another shortcut:<br>
<strong>Mono = Missing One</strong><br>
<strong>Tri = Three copies</strong>
</p>

</div>
  <h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Causes of Chromosomal Aberrations</h4>

<p style="margin:0 0 10px;">
Chromosomal aberrations arise due to errors during cell division or because chromosomes are damaged by physical, chemical, or biological agents. These changes may occur naturally (spontaneous mutations) or may be induced by environmental factors called <strong>mutagens</strong>. The severity of chromosomal abnormalities depends on the type of damage, the chromosome involved, and the number of genes affected.
</p>
...
<th style="border:1px solid var(--line); padding:8px;">Cause</th>

<th style="border:1px solid var(--line); padding:8px;">Effect on Chromosomes</th>
...
<td style="border:1px solid var(--line); padding:8px;"><strong>Errors during Meiosis</strong></td>

<td style="border:1px solid var(--line); padding:8px;">Failure of chromosome separation leading to aneuploidy.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Radiation</strong></td>

<td style="border:1px solid var(--line); padding:8px;">Breaks DNA strands causing deletions, inversions and translocations.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Chemicals</strong></td>

<td style="border:1px solid var(--line); padding:8px;">Damage DNA and interfere with chromosome replication.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Viruses</strong></td>

<td style="border:1px solid var(--line); padding:8px;">Insertion of viral DNA may alter chromosome stability.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><strong>Advanced Maternal Age</strong></td>

<td style="border:1px solid var(--line); padding:8px;">Increases the risk of nondisjunction during meiosis.</td>
...
<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Mutagens Responsible for Chromosomal Damage</h4>

<p style="margin:0 0 8px;">
Mutagens are agents capable of changing the genetic material of an organism. They may directly damage DNA or interfere with chromosome segregation during cell division.
</p>

<ul style="margin:0; padding-left:18px;">

<li><strong>Physical Mutagens:</strong> X-rays, Gamma rays, UV radiation.</li>

<li><strong>Chemical Mutagens:</strong> Mustard gas, Nitrous acid, Benzene, Colchicine.</li>

<li><strong>Biological Mutagens:</strong> Certain viruses such as Human Papillomavirus (HPV), Epstein–Barr Virus (EBV), and Hepatitis B Virus.</li>

</ul>

<div style="margin:14px 0; padding:14px; border:1px solid var(--line); border-radius:10px; background:#fff;">

<div style="display:flex; flex-wrap:wrap; justify-content:center; align-items:center; gap:12px;">

<div style="padding:10px 14px; background:var(--teal-soft); border-radius:8px;">Mutagen</div>

<div style="font-size:20px;">→</div>

<div style="padding:10px 14px; background:#FFE8C2; border-radius:8px;">DNA Damage</div>

<div style="font-size:20px;">→</div>

<div style="padding:10px 14px; background:#FFD6D6; border-radius:8px;">Chromosome Break</div>

<div style="font-size:20px;">→</div>

<div style="padding:10px 14px; background:#D9F8E6; border-radius:8px;">Genetic Disorder</div>

</div>

<p style="margin:10px 0 0; font-size:11.5px; text-align:center; color:var(--ink-soft);">
General pathway showing how mutagens can lead to chromosomal abnormalities.
</p>
...
<p style="margin:6px 0 0; font-size:14px;">
Modern biotechnology uses chromosome analysis to identify inherited disorders, diagnose fetal abnormalities through prenatal testing, study cancer genetics, and improve crop breeding programmes by detecting chromosomal changes.
</p>
...
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Clinical Significance</span>

<p style="margin:6px 0 0; font-size:14px;">
Chromosomal abnormalities are associated with many human disorders including Down syndrome, Turner syndrome, Klinefelter syndrome, recurrent miscarriages, infertility, developmental delay, and several cancers such as chronic myeloid leukemia caused by the Philadelphia chromosome.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Importance of Studying Chromosomal Aberrations</h4>

<ul style="margin:0; padding-left:18px;">

<li>Helps diagnose inherited genetic disorders.</li>

<li>Assists prenatal diagnosis through karyotyping and molecular techniques.</li>

<li>Improves genetic counselling for affected families.</li>

<li>Useful in cancer diagnosis and prognosis.</li>

<li>Supports plant breeding and crop improvement.</li>

<li>Essential in evolutionary and population genetics studies.</li>
...
<br>A → Advanced Maternal Age

<br>M → Meiotic Errors

<br><br>

Remember <strong>RCVAM</strong> to quickly recall the major causes of chromosomal aberrations.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Key Points</h4>

<ul style="margin:0; padding-left:18px;">

<li>Chromosomal aberrations are abnormalities in chromosome number or structure.</li>

<li>They may occur naturally or be induced by mutagens.</li>

<li>Numerical abnormalities mainly result from nondisjunction.</li>

<li>Radiation and chemicals are common chromosome-damaging agents.</li>

<li>Chromosome analysis is important in medicine, biotechnology, agriculture, and cancer research.</li>

</ul>

<div style="margin:14px 0; padding:14px; border-radius:10px; background:linear-gradient(135deg,var(--teal-soft),#ffffff); border:1px solid var(--line);">

<h5 style="margin:0 0 8px; color:var(--teal-deep);">Coming Next → Part 2</h5>

<p style="margin:0;">
In the next section, we will study <strong>Structural Chromosomal Aberrations</strong>, including <strong>Deletion, Duplication, Inversion, and Translocation</strong>, followed by important chromosomal disorders such as <strong>Down Syndrome, Turner Syndrome, Klinefelter Syndrome, Edwards Syndrome, and Patau Syndrome</strong>.
</p>
</div>
      <h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Structural Chromosomal Aberrations</h4>

<p style="margin:0 0 10px;">
Structural chromosomal aberrations are permanent changes in the physical structure of chromosomes caused by chromosome breakage and abnormal rejoining. Unlike numerical aberrations, the chromosome number usually remains unchanged, but the arrangement of genetic material is altered. Depending on the type and location of the break, structural abnormalities may result in loss, gain, or rearrangement of genes, thereby affecting normal development and cellular function.
</p>

<p style="margin:0 0 10px;">
Most structural abnormalities arise due to exposure to mutagens such as ionizing radiation, ultraviolet rays, certain chemicals, viral infections, or errors during DNA repair. Some structural changes are inherited from parents, whereas others occur spontaneously during gamete formation or early embryonic development.
</p>
...
<p style="margin:6px 0 0; font-size:14px;">
<b>Structural chromosomal aberration</b> is a chromosomal abnormality in which one or more chromosome segments are deleted, duplicated, inverted, or translocated because of chromosome breakage and abnormal repair.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Types of Structural Chromosomal Aberrations</h4>

<p style="margin:0 0 10px;">
Structural abnormalities are mainly classified into four major categories based on the nature of chromosome rearrangement.
</p>
...
<th style="border:1px solid var(--line); padding:8px;">Result</th>
...
<td style="border:1px solid var(--line); padding:8px;"><b>Deletion</b></td>

<td style="border:1px solid var(--line); padding:8px;">Loss of chromosome segment</td>

<td style="border:1px solid var(--line); padding:8px;">Missing genes</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Duplication</b></td>

<td style="border:1px solid var(--line); padding:8px;">Extra copy of chromosome segment</td>

<td style="border:1px solid var(--line); padding:8px;">Repeated genes</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Inversion</b></td>

<td style="border:1px solid var(--line); padding:8px;">Segment reversed by 180°</td>

<td style="border:1px solid var(--line); padding:8px;">Gene order changes</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Translocation</b></td>

<td style="border:1px solid var(--line); padding:8px;">Exchange between chromosomes</td>

<td style="border:1px solid var(--line); padding:8px;">Genes move to new location</td>
...
<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">1. Deletion</h4>

<p style="margin:0 0 10px;">
Deletion is the loss of a chromosome segment due to chromosome breakage. The deleted fragment usually lacks a centromere and is therefore unable to attach to the spindle fibres during cell division. Consequently, the fragment is lost, resulting in permanent loss of genes.
</p>
...
<div style="padding:10px 14px; background:var(--teal-soft); border-radius:8px;">
A — B — C — D — E — F
</div>

<div style="font-size:20px;">→</div>

<div style="padding:10px 14px; background:#FFD6D6; border-radius:8px;">
A — B — D — E — F
</div>
...
Deletion removes one or more chromosome segments.
</p>

</div>

<p style="margin:0 0 10px;">
Deletion is generally harmful because essential genes are permanently lost. The severity depends on the size of the deleted region and the importance of the missing genes.
</p>

<div style="margin:12px 0; padding:12px 14px; background:var(--coral-soft); border-left:4px solid var(--coral); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Example</span>

<p style="margin:6px 0 0; font-size:14px;">
Deletion of the short arm of chromosome 5 causes <b>Cri-du-chat Syndrome</b>, characterized by a cat-like cry, developmental delay, microcephaly, and intellectual disability.
</p>

</div>
      <h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">2. Duplication</h4>

<p style="margin:0 0 10px;">
Duplication is a structural chromosomal abnormality in which a chromosome segment is copied and inserted into the same chromosome or another chromosome. As a result, one or more genes occur in multiple copies. This increases gene dosage and may disturb normal gene expression, leading to developmental abnormalities.
</p>

<p style="margin:0 0 10px;">
Duplications usually arise due to unequal crossing-over during meiosis or errors during DNA replication. Although generally less harmful than deletions, large duplications can produce serious genetic disorders.
</p>
...
<div style="padding:10px 14px; background:#D9F8E6; border-radius:8px;">
A — B — C — C — D — E
</div>
...
<p style="margin:10px 0 0; text-align:center; font-size:11.5px; color:var(--ink-soft);">
Duplication results in an extra copy of a chromosome segment.
</p>
...
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Example</span>

<p style="margin:6px 0 0; font-size:14px;">
Duplication of the <b>PMP22</b> gene on chromosome 17 causes <b>Charcot–Marie–Tooth disease type 1A</b>, a hereditary disorder affecting peripheral nerves.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">3. Inversion</h4>

<p style="margin:0 0 10px;">
Inversion occurs when a chromosome breaks at two locations and the broken segment rotates through <strong>180°</strong> before rejoining. Although no genetic material is lost or gained, the order of genes is reversed, which may interfere with normal chromosome pairing during meiosis.
</p>

<p style="margin:0 0 10px;">
Most individuals carrying inversions appear normal because all genes are still present. However, inversions may increase the risk of infertility, recurrent miscarriage, or abnormal offspring due to the formation of abnormal gametes.
</p>
...
<div style="padding:10px 14px; background:#FFE8C2; border-radius:8px;">
A — B — D — C — E
</div>
...
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--ink-soft); font-weight:600;">Types of Inversion</span>

<ul style="margin:8px 0 0; padding-left:18px;">

<li><strong>Paracentric Inversion</strong> – Centromere is not included.</li>

<li><strong>Pericentric Inversion</strong> – Centromere is included.</li>

</ul>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">4. Translocation</h4>

<p style="margin:0 0 10px;">
Translocation is the transfer of a chromosome segment from one chromosome to another non-homologous chromosome. It occurs when broken chromosome fragments are incorrectly rejoined during DNA repair. Translocations may be balanced or unbalanced depending on whether genetic material is lost.
</p>
...
<div style="padding:10px 12px; background:var(--teal-soft); border-radius:8px;">
Chr 1<br>
A — B — C
</div>

<div style="padding:10px 12px; background:#FFE8C2; border-radius:8px;">
Chr 2<br>
X — Y — Z
</div>
...
<div style="padding:10px 12px; background:#D9F8E6; border-radius:8px;">
A — B — Z
</div>

<div style="padding:10px 12px; background:#FFD6D6; border-radius:8px;">
X — Y — C
</div>
...
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Clinical Example</span>

<p style="margin:6px 0 0; font-size:14px;">
The <strong>Philadelphia chromosome</strong>, formed by a translocation between chromosomes <strong>9 and 22 [t(9;22)]</strong>, is associated with <strong>Chronic Myeloid Leukemia (CML)</strong>.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Comparison of Structural Chromosomal Aberrations</h4>
...
<th style="border:1px solid var(--line); padding:8px;">Genetic Material</th>

<th style="border:1px solid var(--line); padding:8px;">Main Effect</th>
...
<td style="border:1px solid var(--line); padding:8px;">Lost</td>
...
<td style="border:1px solid var(--line); padding:8px;">Extra copy</td>

<td style="border:1px solid var(--line); padding:8px;">Increased gene dosage</td>
...
<td style="border:1px solid var(--line); padding:8px;">No loss</td>

<td style="border:1px solid var(--line); padding:8px;">Gene order reversed</td>
...
<td style="border:1px solid var(--line); padding:8px;">Rearranged</td>

<td style="border:1px solid var(--line); padding:8px;">Genes move to another chromosome</td>
...
<br>D → Deletion = DNA Lost

<br>D → Duplication = DNA Doubled

<br>I → Inversion = DNA Inverted

<br>T → Translocation = DNA Transferred
</p>

</div>
     <h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">Important Chromosomal Disorders</h4>

<p style="margin:0 0 10px;">
Chromosomal disorders are genetic conditions caused by abnormalities in chromosome number or structure. They may affect physical growth, intellectual development, reproduction, and overall health. Most disorders result from nondisjunction during meiosis, while some arise from structural chromosome rearrangements.
</p>

<div style="margin:12px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Remember</span>

<p style="margin:6px 0 0; font-size:14px;">
Most human chromosomal disorders are caused by <strong>aneuploidy</strong>, particularly trisomy or monosomy.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:16px 0 8px;">1. Down Syndrome (Trisomy 21)</h4>

<p style="margin:0 0 10px;">
Down syndrome is the most common chromosomal disorder caused by the presence of an extra copy of chromosome 21. The affected individual possesses <strong>47 chromosomes (47,+21)</strong> instead of the normal 46 chromosomes.
</p>
...
<div style="padding:10px 14px; background:#FFD6D6; border-radius:8px;">
Down Syndrome<br>21 + 21 + 21
</div>

</div>

<p style="margin:10px 0 0; text-align:center; font-size:11.5px; color:var(--ink-soft);">
Trisomy 21 produces an extra chromosome 21.
</p>

</div>

<h5 style="color:var(--teal); margin:14px 0 6px;">Characteristics</h5>

<ul style="margin:0; padding-left:18px;">

<li>Intellectual disability</li>

<li>Flat facial profile</li>

<li>Epicanthic eye folds</li>

<li>Short stature</li>

<li>Single transverse palmar crease</li>
...
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Clinical Note</span>

<p style="margin:6px 0 0; font-size:14px;">
The risk of Down syndrome increases with advanced maternal age because nondisjunction becomes more frequent during oocyte meiosis.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">2. Turner Syndrome (Monosomy X)</h4>

<p style="margin:0 0 10px;">
Turner syndrome is a chromosomal disorder affecting females in which one X chromosome is completely or partially absent. The chromosome complement is <strong>45,X</strong>.
</p>
...
<div style="padding:10px 14px; background:#FFD6D6; border-radius:8px;">
Turner Syndrome<br>X
</div>

</div>

<p style="margin:10px 0 0; text-align:center; font-size:11.5px; color:var(--ink-soft);">
Loss of one X chromosome results in monosomy X.
</p>
...
<li>Poor ovarian development</li>

<li>Primary amenorrhea</li>

<li>Infertility</li>

<li>Normal intelligence in most individuals</li>

</ul>

<div style="margin:12px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Diagnosis</span>

<p style="margin:6px 0 0; font-size:14px;">
Turner syndrome is confirmed by karyotyping, which demonstrates the presence of only one X chromosome (45,X).
</p>

</div>
    <h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">3. Klinefelter Syndrome (47,XXY)</h4>

<p style="margin:0 0 10px;">
Klinefelter syndrome is a chromosomal disorder affecting males in which an extra X chromosome is present. The affected individual has <strong>47 chromosomes (47,XXY)</strong>. It results from nondisjunction during meiosis and is one of the most common sex chromosome abnormalities.
</p>
...
<div style="padding:10px 14px; background:#FFD6D6; border-radius:8px;">
Klinefelter Syndrome<br>XXY
</div>

</div>

<p style="margin:10px 0 0; text-align:center; font-size:11.5px; color:var(--ink-soft);">
Presence of an additional X chromosome in males.
</p>
...
<li>Reduced testosterone production</li>

<li>Infertility</li>

<li>Poor facial and body hair growth</li>

<li>Mild learning difficulties in some individuals</li>

<li>Gynecomastia (enlarged breast tissue)</li>
...
<p style="margin:6px 0 0; font-size:14px;">
Diagnosis is confirmed by chromosome analysis showing the presence of an extra X chromosome (47,XXY).
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">4. Edwards Syndrome (Trisomy 18)</h4>

<p style="margin:0 0 10px;">
Edwards syndrome is caused by the presence of an extra chromosome 18. Most affected infants have severe congenital abnormalities and a very low survival rate beyond the first year of life.
</p>
...
<li>Severe developmental delay</li>

</ul>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">5. Patau Syndrome (Trisomy 13)</h4>

<p style="margin:0 0 10px;">
Patau syndrome results from an extra chromosome 13. It is associated with multiple congenital abnormalities affecting the brain, face, heart, and other organs.
</p>
...
<li>Small eyes (Microphthalmia)</li>

<li>Extra fingers or toes (Polydactyly)</li>
...
<li>High infant mortality</li>

</ul>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Comparison of Major Chromosomal Disorders</h4>
...
<th style="border:1px solid var(--line); padding:8px;">Disorder</th>

<th style="border:1px solid var(--line); padding:8px;">Chromosome</th>

<th style="border:1px solid var(--line); padding:8px;">Type</th>

<th style="border:1px solid var(--line); padding:8px;">Major Features</th>
...
<td style="border:1px solid var(--line); padding:8px;"><b>Down Syndrome</b></td>

<td style="border:1px solid var(--line); padding:8px;">47,+21</td>

<td style="border:1px solid var(--line); padding:8px;">Trisomy</td>

<td style="border:1px solid var(--line); padding:8px;">Intellectual disability, heart defects</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Turner Syndrome</b></td>

<td style="border:1px solid var(--line); padding:8px;">45,X</td>

<td style="border:1px solid var(--line); padding:8px;">Monosomy</td>

<td style="border:1px solid var(--line); padding:8px;">Short stature, infertility</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Klinefelter Syndrome</b></td>

<td style="border:1px solid var(--line); padding:8px;">47,XXY</td>

<td style="border:1px solid var(--line); padding:8px;">Sex Chromosome Trisomy</td>

<td style="border:1px solid var(--line); padding:8px;">Tall stature, infertility</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Edwards Syndrome</b></td>

<td style="border:1px solid var(--line); padding:8px;">47,+18</td>

<td style="border:1px solid var(--line); padding:8px;">Trisomy</td>

<td style="border:1px solid var(--line); padding:8px;">Clenched fists, heart defects</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Patau Syndrome</b></td>

<td style="border:1px solid var(--line); padding:8px;">47,+13</td>

<td style="border:1px solid var(--line); padding:8px;">Trisomy</td>

<td style="border:1px solid var(--line); padding:8px;">Cleft palate, polydactyly</td>
...
<strong>21 → Down (Can Drink at 21)</strong><br>

<strong>18 → Edwards (Adult at 18)</strong><br>

<strong>13 → Patau (Unlucky 13)</strong><br>

<strong>X → Turner (Missing X)</strong><br>

<strong>XXY → Klinefelter (Extra X Male)</strong>
...
<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#A8402C; font-weight:600;">Exam Tip</span>

<p style="margin:6px 0 0; font-size:14px;">
For university examinations, remember the chromosome numbers:
<strong>21 → Down, 18 → Edwards, 13 → Patau, X → Turner, XXY → Klinefelter.</strong>
Questions asking to identify these syndromes based on chromosome formulae are very common.
</p>
...
<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Diagnosis of Chromosomal Aberrations</h4>

<p style="margin:0 0 10px;">
Modern cytogenetic and molecular techniques enable scientists to identify chromosomal abnormalities accurately. Early diagnosis helps in prenatal screening, genetic counselling, cancer diagnosis, and treatment planning.
</p>
...
<th style="border:1px solid var(--line); padding:8px;">Technique</th>

<th style="border:1px solid var(--line); padding:8px;">Application</th>
...
<td style="border:1px solid var(--line); padding:8px;"><b>Karyotyping</b></td>

<td style="border:1px solid var(--line); padding:8px;">Detects chromosome number and large structural abnormalities.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>FISH</b></td>

<td style="border:1px solid var(--line); padding:8px;">Detects specific chromosome abnormalities using fluorescent probes.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Comparative Genomic Hybridization (CGH)</b></td>

<td style="border:1px solid var(--line); padding:8px;">Identifies chromosome gains and losses across the genome.</td>

</tr>

<tr>

<td style="border:1px solid var(--line); padding:8px;"><b>Chromosomal Microarray</b></td>

<td style="border:1px solid var(--line); padding:8px;">Detects very small deletions and duplications.</td>
...
<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Applications in Biotechnology</h4>

<ul style="margin:0; padding-left:18px;">

<li>Prenatal diagnosis of genetic disorders.</li>

<li>Cancer diagnosis using chromosomal markers.</li>

<li>Genetic counselling for inherited diseases.</li>

<li>Plant breeding through chromosome manipulation.</li>

<li>Identification of chromosomal mutations in research.</li>

<li>Production of improved crop varieties using polyploidy.</li>

</ul>

<div style="margin:12px 0; padding:12px 14px; background:var(--teal-soft); border-left:4px solid var(--teal); border-radius:8px;">

<span style="font-family:var(--mono); font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:var(--teal-deep); font-weight:600;">Biotechnology Insight</span>

<p style="margin:6px 0 0; font-size:14px;">
Techniques such as karyotyping, FISH, and chromosome microarray have revolutionized the diagnosis of genetic disorders and are now routinely used in hospitals, fertility clinics, and research laboratories.
</p>

</div>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Summary</h4>

<ul style="margin:0; padding-left:18px;">

<li>Chromosomal aberrations involve changes in chromosome number or structure.</li>

<li>Numerical abnormalities include aneuploidy and euploidy.</li>

<li>Structural abnormalities include deletion, duplication, inversion, and translocation.</li>

<li>Most chromosomal disorders arise due to nondisjunction.</li>

<li>Modern cytogenetic techniques allow early diagnosis and treatment planning.</li>

</ul>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Glossary</h4>

<table style="width:100%; border-collapse:collapse; font-size:13px;">

<tbody>

<tr><td style="border:1px solid var(--line); padding:8px;"><b>Aneuploidy</b></td><td style="border:1px solid var(--line); padding:8px;">Gain or loss of one or more chromosomes.</td></tr>

<tr><td style="border:1px solid var(--line); padding:8px;"><b>Euploidy</b></td><td style="border:1px solid var(--line); padding:8px;">Variation in complete chromosome sets.</td></tr>

<tr><td style="border:1px solid var(--line); padding:8px;"><b>Nondisjunction</b></td><td style="border:1px solid var(--line); padding:8px;">Failure of chromosomes to separate.</td></tr>

<tr><td style="border:1px solid var(--line); padding:8px;"><b>Karyotype</b></td><td style="border:1px solid var(--line); padding:8px;">Arrangement of chromosomes in pairs.</td></tr>

<tr><td style="border:1px solid var(--line); padding:8px;"><b>FISH</b></td><td style="border:1px solid var(--line); padding:8px;">Fluorescence In Situ Hybridization.</td></tr>

</tbody>

</table>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Viva Questions</h4>

<ol style="padding-left:20px;">

<li>What are chromosomal aberrations?</li>

<li>Differentiate numerical and structural aberrations.</li>

<li>Define nondisjunction.</li>

<li>What is aneuploidy?</li>

<li>What is deletion?</li>

<li>Name two structural chromosomal abnormalities.</li>

<li>What is Down syndrome?</li>

<li>What causes Turner syndrome?</li>

<li>What is the Philadelphia chromosome?</li>

<li>State one application of FISH.</li>

</ol>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Previous-Year Questions</h4>

<ul style="margin:0; padding-left:18px;">

<li>Define chromosomal aberrations with suitable examples.</li>

<li>Explain numerical chromosomal abnormalities.</li>

<li>Describe structural chromosomal aberrations with neat diagrams.</li>

<li>Write a short note on Down syndrome.</li>

<li>Discuss applications of chromosome analysis in biotechnology.</li>

</ul>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Multiple Choice Questions (MCQs)</h4>

<ol style="padding-left:20px;">

<li>Down syndrome is caused by:<br><b>Answer:</b> Trisomy 21</li>

<li>Turner syndrome chromosome formula is:<br><b>Answer:</b> 45,X</li>

<li>Klinefelter syndrome occurs in:<br><b>Answer:</b> Males</li>

<li>Deletion causes:<br><b>Answer:</b> Loss of genes</li>

<li>Translocation involves:<br><b>Answer:</b> Exchange of chromosome segments</li>

<li>FISH stands for:<br><b>Answer:</b> Fluorescence In Situ Hybridization</li>

<li>Nondisjunction occurs during:<br><b>Answer:</b> Cell division</li>

<li>Patau syndrome is:<br><b>Answer:</b> Trisomy 13</li>

<li>Edwards syndrome is:<br><b>Answer:</b> Trisomy 18</li>

<li>Normal human chromosome number is:<br><b>Answer:</b> 46</li>

</ol>

<h4 style="color:var(--teal-deep); font-size:15px; margin:18px 0 8px;">Frequently Asked Questions (FAQs)</h4>

<p><strong>Q1. What are chromosomal aberrations?</strong><br>
Permanent changes in chromosome number or structure.</p>

<p><strong>Q2. Which syndrome is caused by Trisomy 21?</strong><br>
Down syndrome.</p>

<p><strong>Q3. Which chromosome abnormality is most common in females?</strong><br>
Turner syndrome (45,X).</p>

<p><strong>Q4. Which technique is commonly used for chromosome analysis?</strong><br>
Karyotyping.</p>

<p><strong>Q5. Why are chromosomal aberrations important in biotechnology?</strong><br>
They help in disease diagnosis, prenatal screening, genetic counselling, cancer research, and crop improvement.</p>`
    ] },
